  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-width">Create imaginative and visually stunning images generated by DALL-E AI and share them with the community</p>
      </div> 
      ...
      <div className='mt-36'>
            ...
            <button className='text-[#666e75] text-[14px] ml-3 font-extrabold' onClick={() => {setReset(!reset)}}>Reset</button>
            <ToastContainer />
        </div>
        {
          reset && (

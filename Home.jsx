  ...
  useEffect( () => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        // const response = await fetch(`${import.meta.env.VITE_REACT_APP_ServerLocation}/api/v1/post`, {
        //   method: 'GET',
        //   headers: {
        //     'Content-Type': 'application/json',
        //   },
    ...
    <div>
      <section className="max-w-7xl mx-auto ">
        <div>
          ...
          <p className="mt-2 text-[#666e75] text-[16px] max-width">Browse through a collection of imaginative and visually stunning images generated by DALL-E AI</p>
        </div>
        <div className="mt-16">
          <FormField
